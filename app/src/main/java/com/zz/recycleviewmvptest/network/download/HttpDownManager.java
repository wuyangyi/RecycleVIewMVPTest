...
import com.zz.recycleviewmvptest.network.download.downloadlistener.DownloadInterceptor;
import com.zz.recycleviewmvptest.network.download.exception.HttpTimeException;
import com.zz.recycleviewmvptest.network.download.exception.RetryWhenNetworkException;
...
//        正在下载返回异常信息
        ...
        HttpDownloadService httpService;
        //设置文件的状态为下载
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            httpService = retrofit.create(HttpDownloadService.class);
