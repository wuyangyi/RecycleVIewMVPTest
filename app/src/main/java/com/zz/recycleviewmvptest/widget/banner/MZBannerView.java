...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private int mDelayedTime = 3000;// BindicatorAlignanner 切换时间间隔
    ...
    private int mDataSize = 2; //为2个时，显示前后
    ...
    private void init(){
        View view = null;
        view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_chance_layout,this,true);
     ...
     */
    public void setPages(List<?> datas,MZHolderCreator mzHolderCreator){
